...
trait Sample {
  ...
  object SampleWeapons {
    lazy val NS15 = Weapon("75034","NS-15M",Some("Built on the concept of the NS-11A assault rifle, the remarkably accurate NS-15M LMG provides excellent sustained fire and above average projectile speed. All factions can use NS weapons."),None,"/files/ps2/images/static/8483.png",false,Some("22"))
    lazy val Corvus = Weapon("7152","Corvus VA55",Some("The Corvus VA55 features low recoil and high accuracy over sustained fire, making it a popular choice for long range engagements. VS use only."),Some(1),"/files/ps2/images/static/9470.png",false,Some("16"))
  }
